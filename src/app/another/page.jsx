    ...
    <>
      <div className="bg-white w-full flex h-screen items-center justify-center">
        <div className="flex items-center flex-col gap-y-10">
          ...
          <a
            className="inline-block rounded-lg bg-orange-600 px-8 py-3 text-sm font-medium text-white transition hover:scale-110 hover:shadow-xl focus:outline-none focus:ring active:bg-orange-600 cursor-pointer"
            onClick={() => router.push("/")}
          >
            👈🏻 Go to Home
          </a>
